...
# CONFIGURAÇÃO RATE LIMITER (Anti-Bot)
limiter = Limiter(
    get_remote_address,
    app=app,
...
# --- TABELAS DE ASSOCIAÇÃO (ANTES DA CLASS USER) ---
likes = db.Table(
...
@app.route('/script.js')
def script_js(): return send_from_directory(os.path.join(basedir, '..', 'static'), 'script.js')
